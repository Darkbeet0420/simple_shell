 ...
 * @data: a pointer
 * Return: 0 (if successfull), errcode otherwise
 */
...
/**
 * check_file - checks if exists a file, if it is not a dairectory and if it has excecution permisions for permisions.
